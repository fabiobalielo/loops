...
* Source: http://core.trac.wordpress.org/browser/tags/3.8.3/src/wp-includes/query.php
*/
...
//////Pagination Parameters
    ...
    'posts_per_page' => 10,                 // (int) - number of post to show per page (available with Version 2.1, replaced showposts parameter). Use 'posts_per_page'=>-1 to show all posts (the 'offset' parameter is ignored with a -1 value). Set the 'paged' parameter if pagination is off after using this parameter. 
